...
public class TrackScheduler extends AudioEventAdapter {
    ...
    private final Map<String, Consumer<String>> errorHandlersForTrack;
    ...
    public TrackScheduler(AudioPlayer player) {
        ...
        this.errorHandlersForTrack = new HashMap<>();
     ...
     */
    public void queue(AudioTrack track, Consumer<String> errorHandler) {
        errorHandlersForTrack.put(track.getIdentifier(), errorHandler);
    ...
    public void onTrackException(AudioPlayer player, AudioTrack track, FriendlyException exception) {
        Consumer<String> errorHandler = errorHandlersForTrack.get(track.getIdentifier());

        if (errorHandler != null) {
            errorHandler.accept(
                    "There was an error when playing the track ["
                            + track.getInfo().title + "]:\n "
                            + ExceptionUtils.getRootCause(exception).getMessage());
        } else {
            log.warn("No error handler found for track [" + track.getIdentifier() + "].");
        }
    }
}